...
const SCHOOL_COORDS = {
  ...
  'ctxx':   { name:'成都市草堂小学', district:'青羊区', lng:104.042,lat:30.663, address:'草堂北路' },
  'jsxx':   { name:'成都市金沙小学', district:'青羊区', lng:104.005,lat:30.674, address:'金阳路90号' },
  'rmblxx': { name:'成都市人民北路小学', district:'金牛区', lng:104.074,lat:30.688, address:'人民北路' },
  'ssjxx':  { name:'成都市石笋街小学', district:'金牛区', lng:104.058,lat:30.682, address:'花牌坊街' },
  'cdzxx':  { name:'成都市茶店子小学', district:'金牛区', lng:104.0159,lat:30.6964, address:'育德路39号' },
  'ssxx':   { name:'成都市石室小学', district:'成华区', lng:104.108,lat:30.648, address:'双桥子' },
  'slxx':   { name:'成都市双林小学', district:'成华区', lng:104.102,lat:30.662, address:'双林路' },
